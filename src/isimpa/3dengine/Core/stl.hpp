...
/*! \file stl.hpp
    \brief Implémentation de l'interpréteur de fichier modčle STL (*.stl) 
*/
...
namespace formatSTL
{
	...
	/**
	 * @brief Structure de données du modčle
	 *
	 */
	struct t_model
	{
...
public:
	...
	CStl();
	/**
	 * Méthode d'exportation d'un modčle 3D
	 */
	bool ExportSTL(t_model& sceneconst,const char* mfilename);
	/**
	 * Méthode d'importation d'un modčle 3D
	 */
