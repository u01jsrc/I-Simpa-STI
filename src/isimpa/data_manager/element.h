...
class Element
{
	...
	public :
		...
		enum ELEMENT_TYPE{
			...
			ELEMENT_TYPE_CORE_SPPSNEE_AGH_ADVANCED, /*Obsolete*/
			ELEMENT_TYPE_DIRECTIVITIES_USER,
			ELEMENT_TYPE_FILE,
			ELEMENT_TYPE_REPORT_GABE_RECPS, /*!< Receiver sound level by source */
			ELEMENT_TYPE_CORE_SPPSNEE_AGH_ADVANCED_SPPS,
			ELEMENT_TYPE_CORE_SPPSNEE_AGH_ADVANCED_NEE,
			ELEMENT_TYPE_CORE_SPPSNEE_AGH_ADVANCED_MLT
		};
		/**
		 ...
		 */
		static wxMenuItem* GetMenuItem(wxMenu* parent,int id,const wxString& label, const wxString& menuIcon=wxString());
		static wxMenuItem* GetMenuItem(wxMenu* parent,int id,const wxString& label, wxMenu* subMenu ,const wxString& menuIcon=wxString());
		/**
		...
		*/
		 ...
		 * @see E_Data_Text
		 */
		Element* AppendPropertyText(wxString propertyName,wxString propertyLabel,wxString propertyDefaultValue,bool readOnly=false,bool exportToCore=false);
		/**
		 ...
		 * @see E_Position
		 */
		Element* AppendPropertyPosition(wxString propertyName,wxString propertyLabel,vec3 propertyDefaultValue,bool exportToCore=false);
		/**
		 ...
		 * @see E_Data_List
		 */
		Element* AppendPropertyList(wxString propertyName,wxString propertyLabel,std::vector<wxString> &values,long defaultValue, bool asTitle=false, int hSize=1, std::vector<int> indiceValues=std::vector<int>(),bool exportToCore=false);
		/**
		 ...
		 * @see E_Data_Float
		 */
		Element* AppendPropertyDecimal(wxString propertyName,wxString propertyLabel,float propertyDefaultValue,bool readOnly=false,int precision=4,bool isMaxValue=false,bool isMinValue=false,float maxValue=0,float minValue=0,bool exportToCore=false);
		/**
		 ...
		 * @see E_Data_Bool
		 */
		Element* AppendPropertyBool(wxString propertyName,wxString propertyLabel,bool propertyDefaultValue,bool exportToCore=false);
		/**
		 ...
		 * @see E_Data_Font
		 */
		Element* AppendPropertyFont(wxString propertyName,wxString propertyLabel,wxFont propertyDefaultValue=*wxNORMAL_FONT);
		/** @} */
