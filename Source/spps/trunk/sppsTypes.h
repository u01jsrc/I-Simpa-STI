...
struct CONF_PARTICULE
{
	...
	CONF_PARTICULE(){sourceid=0;currentTetra=NULL;distanceToNextEncombrementEle=0.f;stateParticule=PARTICULE_STATE_ALIVE;tempsEcoule=0.;reflectionOrder=0;diffOrd=0;}
};
